...
GENERATED="${GOPATH}/src/github.com/Myrtilli/transaction-indexing-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/Myrtilli/transaction-indexing-svc/docs/web_deploy"
